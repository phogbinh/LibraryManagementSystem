...
public class FindVisitorByNameTest 
{
    ...
    {
        final String EXPECTED_RESULT = InputOutput.COLLECTION_NAME + COLLECTION_1_NAME + Definitions.END_LINE
            + Definitions.INDENT + InputOutput.COLLECTION_DESCRIPTION + COLLECTION_1_DESCRIPTION + Definitions.END_LINE
            + InputOutput.BOOK_NAME + BOOK_2_NAME + Definitions.END_LINE
            + Definitions.INDENT + InputOutput.BOOK_AUTHOR + BOOK_2_AUTHOR + Definitions.END_LINE
            + Definitions.INDENT + InputOutput.BOOK_DESCRIPTION + BOOK_2_DESCRIPTION + Definitions.END_LINE
            + Definitions.INDENT + InputOutput.BOOK_ISBN + BOOK_2_ISBN + Definitions.END_LINE;
        _findingAaaVisitor.visitCollection( ( Collection )_c1 );
