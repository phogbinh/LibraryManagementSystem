...
public class LibraryTest 
{
    ...
    {
        final String EXPECTED_STRING = Definitions.COLLECTION_NAME + COLLECTION_1_NAME + Definitions.END_LINE
            + Definitions.INDENT + Definitions.COLLECTION_DESCRIPTION + COLLECTION_1_DESCRIPTION + Definitions.END_LINE
            + Definitions.BOOK_NAME + BOOK_1_NAME + Definitions.END_LINE
            + Definitions.INDENT + Definitions.BOOK_AUTHOR + BOOK_1_AUTHOR + Definitions.END_LINE
            + Definitions.INDENT + Definitions.BOOK_DESCRIPTION + BOOK_1_DESCRIPTION + Definitions.END_LINE
            + Definitions.INDENT + Definitions.BOOK_ISBN + BOOK_1_ISBN + Definitions.END_LINE;
